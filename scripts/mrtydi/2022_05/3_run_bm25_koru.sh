...
lang_abbr=ko   # one of {'ar', 'bn', 'en', 'fi', 'id', 'ja', 'ko', 'ru', 'sw', 'te', 'th'}
...
lang_abbr=ru   # one of {'ar', 'bn', 'en', 'fi', 'id', 'ja', 'ko', 'ru', 'sw', 'te', 'th'}
set_name=train   # one of {'train', 'dev', 'test'}
runfile=runs/run.bm25.mrtydi-v1.0-${lang}.${set_name}.txt
...
lang_abbr=te   # one of {'ar', 'bn', 'en', 'fi', 'id', 'ja', 'ko', 'ru', 'sw', 'te', 'th'}
set_name=train   # one of {'train', 'dev', 'test'}
runfile=runs/run.bm25.mrtydi-v1.0-${lang}.${set_name}.txt
