...
if __name__ == '__main__':
    ...
    output_path = "output/dpr-mmarco-fren-train.json"
    generate_examples_train(filepath=filepath, collection_path=collection_path, queries_path=queries_path, bm25_path=bm25_path, output_path=output_path) # fr - en
    queries_path = "/data1/jongho/sigir/data/english_queries.train.tsv"
    output_path = "output/dpr-mmarco-enen-train.json"
    generate_examples_train(filepath=filepath, collection_path=collection_path, queries_path=queries_path, bm25_path=bm25_path, output_path=output_path) # en - en
    # dev
    ...
    output_path = "output/dpr-mmarco-fren-dev.json"
    ...
    # small dev
    filepath = "/data1/jongho/sigir/data/qrels.dev.small.json"
    output_path = "output/dpr-mmarco-enen-dev.small.json"
    generate_examples_dev(filepath=filepath, collection_path=collection_path, queries_path=queries_path, bm25_path=bm25_path, output_path=output_path)
